...
1. **Sequential Thinking:** Kamu WAJIB menggunakan tool `sequentialthinking` untuk setiap tugas, sekecil apa pun itu.
2. **Berpikir Sebelum Bertindak:** Jangan pernah melakukan perubahan file, instalasi paket, atau perintah terminal secara langsung.
3. **Penyampaian Rencana:** Sajikan rencana langkah-demi-langkah hasil dari `sequentialthinking` kepada pengguna.
...
Untuk menjaga penggunaan kuota tetap optimal, patuhi aturan berikut:

12. *Context Scoping:* Hanya baca file yang relevan dengan tugas yang diberikan. Hindari membaca keseluruhan direktori kecuali benar-benar diperlukan.
13. *To-the-Point:* Berikan penjelasan teknis yang padat. Hindari basa-basi, pengulangan instruksi, atau penjelasan filosofis yang panjang.
14. *Re-use Context:* Jika kamu sudah membaca suatu file dalam percakapan ini simpan di memorimu/simpan dan ingat dalam otak kamu, tidak perlu membacanya lagi di langkah berikutnya kecuali jika file tersebut ada perubahan !